...
import { I as LoadingManager, g as Euler, ot as Quaternion, p as Color, xt as Vector3, z as MathUtils } from "../_libs/@react-three/drei+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DkikCyoP.js
			...
			uiHidden ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
							...
							children: [
								...
								panel === "interact" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										children: "左键点身体操作。拖拽捏软组织，姿势拉关节，击腹点击释放环状冲击，拳交拖动手臂沿大肠插入。"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										children: grabbing ? interactMode === "pose" ? "调姿中" : "拖拽中" : interactMode === "strike" ? "击腹就绪" : interactMode === "fist" ? "拳交：拖动手臂插入" : "待机"
									})
								] }) : null,
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: interactMode === "pose" ? "姿势" : interactMode === "strike" ? "击腹" : interactMode === "fist" ? "拳交" : "拖拽" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-border",
							children: "/"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Activity, { className: "size-3.5" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "右键旋转 · 左键点身体操作 · T 拖拽/姿势 · X 透视 · K 骨骼 · W 绑定" })
					]
				})
			] })
		]
...
var Scene = (0, import_react.lazy)(() => import("./scene-L4M0dbuS.mjs"));
function StudioApp() {
